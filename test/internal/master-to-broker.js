...
socketCluster.on('brokerRequest', function (brokerId, data, respond) {
  console.log(`MASTER::Received request data from broker ${brokerId}:`, data);
  if (data.fail) {
...
socketCluster.on('brokerMessage', function (brokerId, data) {
  console.log(`MASTER::Received message data from broker ${brokerId}:`, data);
});
