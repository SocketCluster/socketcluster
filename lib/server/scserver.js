...
var SCServer = function (options) {
  ...
  this._authTokenVerifyOptionsFactory = null;
...
SCServer.prototype.setAuthTokenVerifyOptionsFactory = function (factoryFn) {
  this._authTokenVerifyOptionsFactory = factoryFn;
};

SCServer.prototype.getAuthTokenVerifyOptionsFactory = function () {
  return this._authTokenVerifyOptionsFactory;
};
...
SCServer.prototype.handshake = function (transport, req) {
  ...
  this.auth.parseToken(req, this._authTokenVerifyOptionsFactory, function (err, authToken) {
    ...
    if (forwardedFor) {
      ...
      // TODO: Deprecate clientAddress and remoteAddress in favor of firstAddress
      socket.firstAddress = socket.remoteAddress = socket.clientAddress = forwardedClientIP;
    } else if (req.connection) {
      // TODO: Deprecate clientAddress and remoteAddress in favor of firstAddress
      socket.firstAddress = socket.remoteAddress = socket.clientAddress = req.connection.remoteAddress; 
    }
