...
SCServer.prototype._handleSocketConnection = function (wsSocket) {
  ...
  this.auth.parseToken(wsSocket.upgradeReq, this._authTokenVerifyOptionsFactory, function (err, authToken) {
    ...
    var scSocket = new SCSocket(id, self, wsSocket, authData);
