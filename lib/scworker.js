...
SCWorker.prototype._httpRequestHandler = function (req, res) {
  ...
  // TODO: Deprecate req.remoteAddress in favor of req.firstAddress
  if (forwardedFor) {
    ...
    req.firstAddress = req.remoteAddress = forwardedClientIP;
  } else {
    req.firstAddress = req.remoteAddress = req.connection.remoteAddress;
  }
};
