...
SCWorker.prototype._init = function (options) {
  ...
  this._ioClusterClient = new this._clusterEngine.IOClusterClient({
    ...
    deliveryRetryInitialDelay: this.options.deliveryRetryInitialDelay,
    deliveryRetryMultiplier: this.options.deliveryRetryMultiplier,
  ...
  this._socketServer = socketClusterServer.attach(this._server, {
    ...
    deliveryTimeout: this.options.deliveryTimeout * 1000,
    pingTimeout: this.options.pingTimeout * 1000,
    pingInterval: this.options.pingInterval * 1000,
    ackTimeout: this.options.ackTimeout * 1000,
    upgradeTimeout: this.options.connectTimeout * 1000,
