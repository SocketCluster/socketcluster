...
// TODO: Rethink error handling here to account for custom Errors with name property
// TODO: Add the concept of 'info' events
...
if (cluster.isMaster) {
  ...
  var handleError = function (err) {
    ...
    if (typeof err == 'string') {
      ...
      for (var i in err) {
        if (err.hasOwnProperty(i) && !unserializableErrorProperties[i]) {
          error[i] = err[i];
        }
      }
    }
